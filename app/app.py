...
def home():
    ...
    with open('Data/Cryptocurrency.json') as crypto:
        data = json.load(crypto)
        number_cryptocurrency = len(data["data"])

    return render_template('index.html', data={'categories': categories, 'number_cryptocurrency': number_cryptocurrency,
